      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-bold">MetalCraft</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span className="text-amber-100">info@metalcraft.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-amber-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-amber-100 text-sm">© {new Date().getFullYear()} MetalCraft. All rights reserved.</div>
